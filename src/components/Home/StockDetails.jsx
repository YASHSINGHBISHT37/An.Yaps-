...
const StockDetails = () => {
  ...
  return (
    <div className="Stock-Details pt-110 absolute z-50 w-screen h-auto pointer-events-none">
      <div className="cont relative w-full h-full mt-32 rounded-t-3xl py-14 flex flex-col gap-4
        ...
        {/* Market Stats */}
        <div className="Market-stats mx-4 border-b border-white/20 dark:border-[#161616]/20 pb-4 select-none">
          ...
          <div className='cont mt-3 flex flex-wrap justify-center gap-x-2 gap-y-3'>
            {marketStats.map((item, i) => (
              <div key={i} className='stat leading-4.5 px-2 py-2 rounded-lg bg-white/5 dark:bg-[#161616]/10 text-center w-[10.4vh]'>
        ...
        <div className="About mx-4 border-b border-white/20 dark:border-[#161616]/20 pb-4">
          <h1 className='font-bold opacity-70 text-[1.8vh] tracking-tight select-none'>About</h1>
          <p className='leading-4.5 mt-3 text-[1.6vh] select-none'>
        ...
        {/* Assets */}
        <div className="Assets h-auto pb-8 mb-3 ">
          <div className='flex mx-4 justify-between items-end mb-5 select-none'>
          ...
          <div className="Cont mx-3 border border-white/15 dark:border-[#161616]/30 rounded-3xl">
            {assets.map((item, i, arr) => (
              <div key={i} className={`Stock bg-white/5 dark:bg-[#161616]/10 px-4 flex justify-between items-center py-2.5 active:bg-white/10 hover:bg-white/10
                                      transition cursor-pointer select-none pointer-events-auto
